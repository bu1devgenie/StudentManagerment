...
import com.app.studentManagerment.controller.AuthorGGDriveController;
...
public class GoogleDriveConfig {
    ...
    private AuthorGGDriveController authorGGDriveController;


    @Autowired
    public GoogleDriveConfig(GGcloud_credentialRepository gGcloudCredentialRepository, AuthorGGDriveController authorGGDriveController) {
        this.gGcloudCredentialRepository = gGcloudCredentialRepository;
        this.authorGGDriveController = authorGGDriveController;
    }
