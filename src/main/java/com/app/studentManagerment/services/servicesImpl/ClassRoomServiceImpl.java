...
public class ClassRoomServiceImpl implements ClassRoomService {
	...
	public ClassRoomServiceImpl(ClassroomRepository classroomRepository, TeacherRepository teacherRepository, CourseRepository courseRepository, StudentRepository studentRepository, SemesterRepository semesterRepository, ClassRoomListMapper classRoomListMapper, SessionRepository sessionRepository) {
...
//        Page<ClassRoom> classRoom = classroomRepository.searchClassRoom( msgv, pageable);
	...
	@Override
	public List<TimeClassDto> getTimeClass(String className) {
		ClassRoom classRoom = classroomRepository.findByName(className);
		if (classRoom != null) {
			return sessionRepository.getTimeClass(className);
		}
		return null;
	}

	@Override
	public List<String> getClassRoomForRegister(String courseName) {
		return classroomRepository.getClassRoomForRegister(courseName);
	}
}
